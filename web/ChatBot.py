class ChatBot:
    def __init__(self):
        ...
        self.command_list = ['Создать новое соревнование', 'Создать новую группу',
                             'Для добавления нового результата перейдите в группу', 'Добавить нового ученика']
    ...
    def add_message(self, text):
        ...
        if text == self.command_list[0]:
            ...
            self.__msg2list('Перейдите в группу или к ученику')
    ...
    def get_html_page(self):
        command2html = {
            ...
            self.command_list[2]: 'group.html',
